...
export const initialBlogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    en: {
      ...
      content:
        "I overlaid Rorschach inkblot tests from psychology onto a city skyline, creating a visual field suspended between reality and the subconscious. Where the rational order of architecture meets the chaotic randomness of ink, unexpected narrative tension is born.",
      detailContent:
